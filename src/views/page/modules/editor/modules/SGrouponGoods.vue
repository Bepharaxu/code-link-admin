<template>
  <div class="select-goods">
    ...
    <div class="data-add">
      <a-button icon="plus" @click="handleSelectGoods()">选择拼团商品</a-button>
    </div>
    <GrouponGoodsModal
      ref="GrouponGoodsModal"
      :maxNum="maxNum"
...
import { GrouponGoodsModal } from '@/components/Modal'

// 仅需要的字段
const itemColumns = ['groupon_goods_id', 'goods_name', 'goods_image', 'groupon_price', 'original_price', 'show_people', 'active_sales']
...
export default {
  ...
  methods: {
    ...
    // 打开商品选择器
    handleSelectGoods () {
      this.$refs.GrouponGoodsModal.handle()
    },
