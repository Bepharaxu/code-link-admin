<template>
  <div class="select-goods">
    ...
    <div class="data-add">
      <a-button icon="plus" @click="handleSelectGoods()">选择砍价商品</a-button>
    </div>
    <BargainGoodsModal
      ref="BargainGoodsModal"
      :maxNum="maxNum"
...
import { BargainGoodsModal } from '@/components/Modal'

// 仅需要的字段
const itemColumns = ['active_id', 'goods_name', 'goods_image', 'floor_price', 'original_price']
...
export default {
  ...
  methods: {
    ...
    // 打开商品选择器
    handleSelectGoods () {
      this.$refs.BargainGoodsModal.handle()
    },
