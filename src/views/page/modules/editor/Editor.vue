<template>
  <div class="editor">
    ...
    <template v-if="data.items.length && curItem">
      ...
      <!-- 线下门店 -->
      <div v-if="curItem.type == 'shop'" class="editor-content">
        <a-tabs>
          <a-tab-pane key="1" tab="内容设置">
            <div class="block-box">
              <div class="block-title">
            ...
            <!-- 手动选择 -->
            <div v-if="curItem.params.source === 'choice'" class="block-box">
              <div class="block-title">选择门店 ({{ curItem.data.length }})</div>
              <SShop v-model="curItem.data" />
            </div>
            <!-- 自动获取 -->
            <div v-if="curItem.params.source === 'auto'" class="block-box">
              <div class="block-item">
                <span class="label">显示数量</span>
                <div class="block-item-right">
                  <a-input-number v-model="curItem.params.auto.showNum" :min="1" :max="30" />
                  <span class="unit-text">
                    <span>个</span>
                  </span>
                </div>
          ...
          <a-tab-pane key="2" tab="样式设置">
            <div class="block-box">
              ...
              <div class="block-item">
                ...
                <div class="item-checkbox" :style="{ width: '180px' }">
                  <a-checkbox-group v-model="curItem.style.show">
                    <a-checkbox value="logo">门店logo</a-checkbox>
                    <a-checkbox value="address">门店地址</a-checkbox>
                    <a-checkbox value="phone">门店电话</a-checkbox>
                  </a-checkbox-group>
                </div>
              </div>
            </div>
      ...
      <!-- 砍价商品 -->
      <div v-if="curItem.type == 'bargain'" class="editor-content">
        <a-tabs>
          <a-tab-pane key="1" tab="内容设置">
            <div class="block-box">
              <div class="block-title">
            ...
            <div v-if="curItem.params.source === 'choice'" class="block-box">
              <div class="block-title">选择商品 ({{ curItem.data.length }})</div>
              <SBargainGoods v-model="curItem.data" />
            </div>
            <!-- 自动获取 -->
            <div v-if="curItem.params.source === 'auto'" class="block-box">
              <div class="block-title">商品内容</div>
            ...
            <div class="block-box">
              ...
              <div class="block-item">
                ...
                <div class="item-checkbox" :style="{ width: '180px' }">
                  <a-checkbox-group v-model="curItem.style.show">
                    <a-checkbox value="goodsName">商品名称</a-checkbox>
                    <a-checkbox value="peoples">正在砍价</a-checkbox>
                    <a-checkbox value="floorPrice">商品底价</a-checkbox>
                    <a-checkbox value="originalPrice">商品原价</a-checkbox>
                  </a-checkbox-group>
                </div>
              </div>
            </div>
      ...
      <!-- 整点秒杀 -->
      <div v-if="curItem.type == 'sharp'" class="editor-content">
        <a-tabs>
          <a-tab-pane key="1" tab="内容设置">
            <div class="block-box">
              <div class="block-title">商品内容</div>
              ...
              <div class="block-item">
                <span class="label">显示数量</span>
                <div class="block-item-right">
                  <a-input-number v-model="curItem.params.showNum" :min="1" :max="30" />
                  <span class="unit-text">
                    <span>个</span>
                  </span>
                </div>
            ...
            <div class="block-box">
              ...
              <div class="block-item">
                ...
                <div class="item-checkbox" :style="{ width: '180px' }">
                  <a-checkbox-group v-model="curItem.style.show">
                    <a-checkbox value="goodsName">商品名称</a-checkbox>
                    <a-checkbox value="seckillPrice">秒杀价格</a-checkbox>
                    <a-checkbox value="originalPrice">商品原价</a-checkbox>
                  </a-checkbox-group>
                </div>
              </div>
      ...
      <!-- 拼团商品 -->
      <div v-if="curItem.type == 'groupon'" class="editor-content">
        <a-tabs>
          <a-tab-pane key="1" tab="内容设置">
            <div class="block-box">
              <div class="block-title">
            ...
            <div v-if="curItem.params.source === 'choice'" class="block-box">
              <div class="block-title">选择商品 ({{ curItem.data.length }})</div>
              <SGrouponGoods v-model="curItem.data" />
            </div>
            <!-- 自动获取 -->
            <div v-if="curItem.params.source === 'auto'" class="block-box">
              <div class="block-title">商品内容</div>
          ...
          <a-tab-pane key="2" tab="样式设置">
            <div class="block-box">
              ...
              <div class="block-item">
                <span class="label">边角样式</span>
                <a-radio-group buttonStyle="solid" v-model="curItem.style.itemBorderRadius">
                  <a-radio-button value="right">直角</a-radio-button>
              ...
              <div class="block-item">
                <span class="label">商品内容</span>
                <div class="item-checkbox" :style="{ width: '180px' }">
                  <a-checkbox-group v-model="curItem.style.show">
                    <a-checkbox value="goodsName">商品名称</a-checkbox>
                    <a-checkbox value="button">购买按钮</a-checkbox>
                    <a-checkbox value="peoples">拼团人数</a-checkbox>
                    <a-checkbox value="activeSales">拼团销量</a-checkbox>
                    <a-checkbox value="grouponPrice">拼团价格</a-checkbox>
                    <a-checkbox value="originalPrice">商品原价</a-checkbox>
                  </a-checkbox-group>
                </div>
              </div>
