        ...
        >
          ...
          <a-descriptions title="自提信息">
            <a-descriptions-item label="姓名">
              <span class="c-p">{{ record.extract.linkman }}</span>
              <span class="f-13 ml-5">(取货人)</span>
            </a-descriptions-item>
            <a-descriptions-item label="电话">
              <span class="c-p">{{ record.extract.phone }}</span>
              <span class="f-12 ml-5">(取货人)</span>
            </a-descriptions-item>
            <a-descriptions-item label></a-descriptions-item>
            <a-descriptions-item label="自提门店">
              <a-tooltip>
                <template slot="title">门店ID: {{ record.extract_shop.shop_id }}</template>
                <span>{{ record.extract_shop.shop_name }}</span>
              </a-tooltip>
            </a-descriptions-item>
            <a-descriptions-item label="门店联系人">{{ record.extract_shop.linkman }}</a-descriptions-item>
            <a-descriptions-item label="门店电话">{{ record.extract_shop.phone }}</a-descriptions-item>
            <a-descriptions-item label="门店地址">
              <span>{{ record.extract_shop.region.province }}</span>
              <span>{{ record.extract_shop.region.city }}</span>
              <span>{{ record.extract_shop.region.region }}</span>
              <span class="ml-5">{{ record.extract_shop.address }}</span>
            </a-descriptions-item>
          </a-descriptions>
          <!-- 核销信息 -->
          <template
          ...
          >
            ...
            <a-descriptions title="核销信息">
              ...
              <a-descriptions-item label="核销员">
                <a-tooltip>
                  <template slot="title">核销员ID: {{ record.extract_clerk.clerk_id }}</template>
                  <span>{{ record.extract_clerk.real_name }}</span>
                </a-tooltip>
              </a-descriptions-item>
