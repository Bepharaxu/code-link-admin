                      ...
                      <td :rowspan="item.goods.length">
                        <div class="actions">
                          <router-link
                            ...
                            target="_blank"
                          >订单详情</router-link>
                          <template v-if="item.delivery_method == DeliveryMethodEnum.EORDER.value">
                            <a
                              v-if="$auth('/order/tools/delivery.eorder')"
...
import { EorderShow } from './modules'
