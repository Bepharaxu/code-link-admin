  ...
  <a-card :bordered="false">
    <a-spin :spinning="isLoading">
      ...
      <div class="table-operator">
        ...
        <!-- 操作板块 -->
        <a-row class="actions">
          <div class="action-item" v-if="$auth('/order/tools/delivery/batch')">
            <router-link :to="{ path: '/order/tools/delivery/batch' }">
                      ...
                      <td :rowspan="item.goods.length">
                        <div class="actions">
                          ...
                          >
                            ...
                            <a
                              v-if="$module('order-eorder')"
                              v-action:eorder
                              @click="handleEorder(item)"
                            >电子面单</a>
                          </template>
                        </div>
                      </td>
      ...
      <EorderForm ref="EorderForm" @handleSubmit="handleRefresh" />
    </a-spin>
  </a-card>
</template>
...
import { EorderForm } from './modules'
